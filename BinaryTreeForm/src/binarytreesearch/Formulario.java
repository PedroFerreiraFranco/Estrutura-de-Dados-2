...
public class Formulario extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel3.setText("Busca de filmes");
     ...
     String csvFile = "dados.csv";
        ...
        try (BufferedReader br = new BufferedReader(new FileReader(csvFile))) {
            while ((line = br.readLine()) != null) {
                ...
                filme.setCodigo(Integer.parseInt(leitura[0]));
                filme.setNome(leitura[1]);
                int qtd = tree.add(filme);
                
            }// fim percurso no arquivo
            String filmeData = tree.getFilmeDataPreOrder();
            listMostraDados.append(filmeData);
        } catch (IOException e) {
            e.printStackTrace();
        }
    }
